(defproject hpmanager "0.1.0-SNAPSHOT"
  ...
  {:handler hpmanager.handler/app
   ...
   :destroy hpmanager.handler/destroy
   :name "hpmanager.war"}
                  ...
                  {:builds
                   {:app
                    {:source-paths ["src/cljs" "src/cljc" "env/dev/cljs"]
                     :figwheel {:on-jsload "hpmanager.core/mount-components"}
                     :compiler
                     {:main "hpmanager.app"
                      :asset-path "/js/out"
                      :output-to "target/cljsbuild/public/js/app.js"
